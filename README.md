...
* Measuring Biological Diversity, Anne E. Magurran (2004). [available online soon!](http://www.sciencedirect.com/science/bookseries/01678892/24)) *(and on reserve in Life Science Library)*
* Biological Diversity, Magurran and McGill (2011) ([available online soon!](http://www.sciencedirect.com/science/bookseries/01678892/24))
...
What is biodiversity and why do we study it? After providing an overview of the course, we will provide an overview of GitHub and R. Laboratory exercises will include an introduction to using GitHub followed by exercises in R such as data manipulations, plotting, and simple statistics. 
...
We will compare and contrast null, neutral, and niche-based explanations for biodiversity patterns using simple individual-based models, explore patterns of biodiversity (SAD, SAR, DD, SSAD, measures of alpha & beta-diversity).
...
### Week 8
***Synthesis***<br>
We will use this class period for recapping major concepts and tools. We will also devote class time to transferring IU GitHub respositories to a public GitHub site. 
